...
if ($dataSelecionada) {
    $urlIntegracaoVendas = "http://192.168.0.210/painel/integracao_vendas_data.php?data=".$dataSelecionada;
    $urlDuplicidadePdvDocto = "http://192.168.0.210/painel/duplicidade_pdv_docto_data.php?data=".$dataSelecionada;
    $urlVendaLojaDia = "http://192.168.0.210/painel/venda_loja_dia_data.php?data=".$dataSelecionada;
...
<body>
    ...
    <script>
        async function fetchData() {
            ...
            const urls = [
                `http://192.168.0.210/painel/integracao_vendas.php?data=${date}`,
                `http://192.168.0.210/painel/duplicidade_pdv_docto.php?data=${date}`,
                `http://192.168.0.210/painel/venda_loja_dia.php?data=${date}`,
                `http://192.168.0.210/painel/jobs.php?data=${date}`
            ];
