		...
		<div class="row">
            <ul class="host">
                ...
                <li><img src="img/icon_server.ico" style="width:40px;"> 192.168.0.225            
                    <ul class="tree">
                        <li><span id="AvancoNovo_236"></span> AvancoNovo_236 <span id="AvancoNovo_236_disco"></span></li>
                        <li><span id="AvancoUbuntu_240"></span> AvancoUbuntu_240 <span id="AvancoUbuntu_240_disco"></span></li>
                        <li><span id="C5ColetCont_248"></span> Consinco Web 248 <span id="C5ColetCont_248_disco"></span></li>
                        <li><span id="NovoIntraNet_210"></span> IntraNet_210 <span id="NovoIntraNet_210_disco"></span></li>
                        <!--li><span id="Proxy_250"></span> Proxy_250</li-->
                        <li><span id="SocinC5_251"></span> SocinC5_251 <span id="SocinC5_251_disco"></span></li>
                        <li><span id="SrvDocs_150"></span> SrvDocs_150 <span id="SrvDocs_150_disco"></span></li>
                        <!--li><span id="SrvEmail_250"></span> SrvEmail_250</li-->
                        <li><span id="Veltio_249"></span> Veltio_249 <span id="Veltio_249_disco"></span></li>                        
                        <li><span id="VoipBig_220"></span> VoipBig_220 <span id="VoipBig_220_disco"></span></li>
                        <li><span id="VoipE1_222"></span> VoipE1_222 <span id="VoipE1_222_disco"></span></li>
					</ul>                
				</li>
				<li><span id="Antigo_Totvs_243"></span> Antigo_Totvs_243 <span id="Antigo_Totvs_243_disco"></li>
					<li><span id="Totvs_203"></span> Totvs_203 <span id="Totvs_203_disco"></li>
						<li><img src="img/icon_server.ico" style="width:40px;"> 192.168.0.226            
							<ul class="tree">                        
								<li><span id="IIS_TotvCurric_228"></span> IIS_TotvCurric_228 <span id="IIS_TotvCurric_228_disco"></span></li>
								<li><span id="NDD_244"></span> NDD_244 <span id="NDD_244_disco"></span></li>
								<!--li><span id="Python_209"></span> Python_209</li-->
								<li><span id="SrvDpNovo_130"></span> SrvDpNovo_130 <span id="SrvDpNovo_130_disco"></span></li>
								<li><span id="SrvGED_200"></span> SrvGED_200</li>
								<li><span id="Supervisorio_100"></span> Supervisorio_100 <span id="Supervisorio_100_disco"></span><span id="Supervisorio_100_banco"></span></li>
				...
				success: function(data) {
					...
					$.each(data, function(index, item) {
						...
						if (['251', '1', '2', '4', '5', '8', '9'].includes(item.controle_loja)) {
							...
							html += '<div class="col-md-2" style="padding:3px;"><ul class="list-group">\
