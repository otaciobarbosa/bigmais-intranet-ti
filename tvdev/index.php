...
<html lang="pt-br" translate="no">
	...
	<head>
		...
		<style>
			...
			td{text-align:center !important;padding-left:10px;}    
			...
			.size{font-size:16px;font-weight:600;padding:0px;text-align:left;} 
			...
			<div class="row">			
				...
				<div class="col-md-12">			
					...
					<script>
						...
						setInterval(() => $('#conc_251').load("/intranet/server/server_conc_251_tvdev.php").fadeIn("slow"), 5000);
					});
					</script>
						...
						success: function(data) {
							...
							$.each(data, function(index, item) {													
								...
								if (['203'].includes(item.controle_loja)) {
									...
									server203 += '<span class="fundo_disco" style="'+fundo+'"><span style="color:yellow;"> C: '+ espacoTotal.toFixed(0) + 'gb  </span> / <span style="color:yellow;">'+ percentualOcupacao + '% </span></span>';
									...
									server203 += '<span class="fundo_disco" style="'+fundo+'"><span style="color:yellow;">D: '+ espacoTotal.toFixed(0) + 'gb </span> / <span style="color:yellow;">'+ percentualOcupacao + '% </span></span>';
