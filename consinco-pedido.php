...
<div class="card">
            <div class="card-body">
            <h3>INFO: D=Digitacao | A=Analise | L=Liberado | C=Cancelado | S=Separacao | P=Pre-separacao | R=Roteirizacao | W=Separado | F=Faturado</h3>
                ...
                <table id="senhas" class="table table-condensed table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style='font-size:12px;text-align:center;'><?php echo $row['SITUACAOPED']; ?></td>
                            <td style='font-size:12px;text-align:center;'><?php echo $row['NROPEDVENDA']; ?></td>
                            ...
                            <td style='font-size:12px;text-align:center;'>
                                ...
                                <form class="form-inline" action="consinco-pedido-ajustar.php" method='GET'>
                                    <div class="form-group">
                                        <input type="hidden" id="pedido" name="pedido" value="<?php echo $row["NROPEDVENDA"]; ?>">
                                    </div>
